...
const EditBookView = (props: IEditBookProps) => {

    const colors = ['#F9D1D5', '#FFFBC7', '#DDF8C9', '#D6CFFC']
    const [colorIndex, setColorIndex] = useState(0)

    const title = props.data ? 'Edit Book' : 'Add Book'
        ...
        >
            <KeyboardAvoidingView style={styles.container} >
                ...
                <View style={styles.content}>
                    <Text style={styles.label}>Book Text:</Text>
                    <TextInput
                        style={styles.input}
